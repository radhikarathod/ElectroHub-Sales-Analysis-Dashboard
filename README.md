...
1.	Identify the Top and Bottom 5 products based on Sales, Profit, and Quantity Sold.
...
6.	Determine the total number of orders.
7.	Provide a detailed order-level view, including Sales, Profit, Discount, Net Sales, etc., with filtering options based on Product, Date, Customer ID, and Promotion Categories.
